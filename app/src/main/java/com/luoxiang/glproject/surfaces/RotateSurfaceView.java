...
public class RotateSurfaceView
    ...
    public RotateSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    /**
            ...
            implements Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            mCube = new Cube(RotateSurfaceView.this);
            //深度测试
