 ...
 * upDateDesc:	        TODO
 */
public class TextureImgSurfaceView extends GLSurfaceView {
    //纹理ID
    int mTextureId;
    SceneRenderer mRenderer;

    public TextureImgSurfaceView(Context context) {
        this(context , null);
    }

    public TextureImgSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
